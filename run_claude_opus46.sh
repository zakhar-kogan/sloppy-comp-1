...
WORKDIR="/Users/zakhar/benchmark/claude-opus46"
RESULTS="/Users/zakhar/benchmark/results/claude-opus46.csv"
OUTPUT_LOG="/tmp/claude_opus46_output.log"
...
cd "$WORKDIR"
claude -p --model opus --dangerously-skip-permissions "$PROMPT" > "$OUTPUT_LOG" 2>&1 &
PID=$!
echo "PID: $PID"
