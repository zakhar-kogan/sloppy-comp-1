...
WORKDIR="/Users/zakhar/benchmark/opencode-opus46"
RESULTS="/Users/zakhar/benchmark/results/opencode-opus46.csv"
OUTPUT_LOG="/tmp/opencode_opus46_output.log"
...
cd "$WORKDIR"
opencode run -m "quotio/kiro-claude-opus-4-6" "$PROMPT" > "$OUTPUT_LOG" 2>&1 &
PID=$!
echo "PID: $PID"
